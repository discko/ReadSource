package space.wudi.readsourceaop.cglibproxy.aspect;
...
//    @Pointcut("@annotation(space.wudi.readsourceaop.cglibproxy.annotation.AspectJoinPoint)")
    @Pointcut("execution(* space.wudi.readsourceaop.cglibproxy.service.CgLibDynamicService.*(..))")
