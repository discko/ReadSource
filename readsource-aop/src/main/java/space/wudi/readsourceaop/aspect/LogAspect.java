...
public class LogAspect {
    ...
    //@Pointcut("execution(public String space.wudi.readsourceaop.controller.MyController.getInfo(String))")
    ...
    public Object logAfterReturningController(JoinPoint joinPoint, Object rtVal){
        ...
        if(rtVal instanceof String){
            return ((String)rtVal)+" modified by aspect";
        }
